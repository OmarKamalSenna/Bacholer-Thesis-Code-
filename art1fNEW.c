...
int artmn_(void)
{
	...
	for (imany = 1; imany <= i__1; ++imany)
	{
		...
		r__1 = -b / 2.f;
		r__2 = input3_1.zeropt - zdist / 2.f;
		init_(&i__2, &mass, &run_1.num, &radpr, &r__1, &r__2, &pzpr, &gammpr,&input1_1.iseed, &mass, &input2_1.imomen);
		outpar = 0;
		rr_1.massr[0] = 0;
		i__2 = run_1.num;
		for (ir = 1; ir <= i__2; ++ir)
		...
		for (nt = 1; nt <= i__2; ++nt)
		{
			...
			for (irun = 1; irun <= i__4; ++irun)
			{
				...
				for (j = 1; j <= i__3; ++j)
				{
					...
					if (ix < 20 && iy < 20 && iz < 24 && ix > -20 && iy > -20 && iz > -24)
					{
						if (dd_1.rho[ix + (iy + iz * 41) * 41 + 41184] /.168f >5.f &&cc_1.e[i__ - 1] > .9f)
						{
							++nbaryn;
						}
		...
		if (arprnt_1.iapar2[0] != 1)
		{
			...
			for (irun = 1; irun <= i__2; ++irun)
			{
				...
				for (i__ = 1; i__ <= i__3; ++i__)
				{
					...
					arprc1_1.gx1[i__ + irun * 150001 - 150002] = aa_1.r__[ib *3 -3];
					arprc1_1.gy1[i__ + irun * 150001 - 150002] = aa_1.r__[ib *3 -2];
					arprc1_1.gz1[i__ + irun * 150001 - 150002] = aa_1.r__[ib *3 -1];
					if (arprc1_1.ft1[i__ + irun * 150001 - 150002] < ct)
					{
						arprc1_1.ft1[i__ + irun * 150001 - 150002] = ct;
					}
					arprc1_1.px1[i__ + irun * 150001 - 150002] = bb_1.p[ib *3 -3];
					arprc1_1.py1[i__ + irun * 150001 - 150002] = bb_1.p[ib *3 -2];
					arprc1_1.pz1[i__ + irun * 150001 - 150002] = bb_1.p[ib *3 -1];
					arprc1_1.xm1[i__ + irun * 150001 - 150002] = cc_1.e[ib -1];
					...
					arprc1_1.ee1[i__ + irun * 150001 - 150002] = sqrt(r__1 * r__1 + r__2 * r__2 + r__3 * r__3 + r__4 * r__4);
			...
			int *lnnrho, int *lnnom, int *nt, int *ntmax, float *sp, float *akaon, float *sk)
{
	...
	extern int crnd_(int *, float *, float *, float *, float *, int *, int *, int *, float *, float *, float *, float *, float *, float *, float *, float *, int *, int *), cren_(float *, float *, float *, float *, int *, int *, int *);
	static int ntag;
	extern int crrd_(float *, float *, float *, float *, int *, int *, int *, float *, float *, float *, float *), crpd_(float *, float *, float *, float *, int *, int *, int *,float *, float *, float *, float *);
	static float sigk;
	static int lpdr;
	...
	static float xres;
	extern int crpn_(float *, float *, float *, float *, int *, int *, int *, float *, float *, float *, float *), crnn_(int *, float *, float *, float *, float *, int *, int *,int *, int *, float *, float *, int *, int *);
	static float ppel;
	...
	static float deltre;
	extern int distce_(int *, int *, float *, float *,float *, float *, float *, int *, float *, float *, float *),pibphi_(float *, int *, int *, float *, float *, float *,float *);
	...
	extern double ppbbar_(float *), prbbar_(float *), rrbbar_(float *),pobbar_(float *), robbar_(float *), oobbar_(float *), xppbar_(float *);
	static float dsppbr;
	extern int crppba_(float *, float *, float *, float *,int *, int *, int *),pertur_(float *, float *, float *,float *, int *, int *, int *, int *, int *,int *);
	static int icontp;
	extern int crphib_(float *, float *, float *, float *,int *, int *, float *, float *, float *, float *, float *,float *, int *),phimes_(int *, int *, float *, float *,float *, float *, float *, float *, float *, float *, float *);
	static float sigphi;
	extern int crphim_(float *, float *, float *, float *,int *, int *, float *, float *, float *, float *, float *,float *, float *, int *, int *, int *),
		xkhype_(int *,int *, float *, float *, float *, float *, float *, float *,float *, float *, float *, float *, float *, float *, float *, float *,float *, float *, float *, float *, float *),
		crkhyp_(float *, float *,float *, float *, int *, int *, float *, float *, float *,float *, float *, float *, float *, float *, float *, float *, float *,float *, float *, float *, float *, float *, float *, float *, int *,int *),
        crkphi_(float *, float *, float *, float *, float *,int *, float *, float *, int *, int *, int *,int *, int *, int *, float *, float *),crksph_(float *,float *, float *, float *, float *, float *, float *, int *,int *, int *, int *, int *, int *, int *,int *, float *);
	...
	for (irun = 1; irun <= i__1; ++irun)
	{
		...
		for (j1 = j10; j1 <= i__2; ++j1)
		{
			...
			if (xdecay < pdecay)
			{
				...
				if (*nt == *ntmax && ftmax_1.ftsv[i1 - 1] > (*ntmax - 1) *input1_1.dt)
				{
		...
		L1:
			...
			for (j2 = 1; j2 <= i__3; ++j2)
			{
				...
				deltr0 = 3.f;
				if (abs(leadng_1.lb1) >= 14 && abs(leadng_1.lb1) <= 17 || abs(leadng_1.lb1) >= 30 &&abs(leadng_1.lb1) <= 45)
				{
					deltr0 = 5.f;
				}
				if (abs(dpi_1.lb2) >= 14 && abs(dpi_1.lb2) <= 17 || abs(dpi_1.lb2) >= 30 &&abs(dpi_1.lb2) <= 45)
				{
					deltr0 = 5.f;
				}
				...
				if (dpi_1.lb2 == 23 && (leadng_1.lb1 >= 14 && leadng_1.lb1 <=17))
				{
					goto L3699;
				}
				...
				{
					if (leadng_1.lb1 == 0 || leadng_1.lb1 >= 25 &&leadng_1.lb1 <= 28)
					{
						goto L3699;
					}
				}
				...
				else if (abs(dpi_1.lb2) == 30 && (leadng_1.lb1 == 0 ||leadng_1.lb1 >= 25 && leadng_1.lb1 <= 28 ||leadng_1.lb1 >= 3 && leadng_1.lb1 <= 5))
				{
					goto L3699;
				}
				else if (abs(leadng_1.lb1) == 30 && (abs(dpi_1.lb2) == 1 ||abs(dpi_1.lb2) == 2 || abs(dpi_1.lb2) >= 6 && abs(dpi_1.lb2) <= 13))
				{
					goto L3699;
				}
				...
				if ((leadng_1.lb1 == 23 || leadng_1.lb1 == 21) && (abs(dpi_1.lb2) == 1 ||abs(dpi_1.lb2) == 2 || abs(dpi_1.lb2) >= 6 && abs(dpi_1.lb2) <= 13))
				{
					goto L3699;
				}
				else if ((dpi_1.lb2 == 23 || dpi_1.lb2 == 21) && (abs(leadng_1.lb1) == 1 ||abs(leadng_1.lb1) == 2 || abs(leadng_1.lb1) >= 6 && abs(leadng_1.lb1) <= 13))
				{
					goto L3699;
				}

				rppmax = 3.57f;
				if ((leadng_1.lb1 == -1 || leadng_1.lb1 == -2 || leadng_1.lb1 >= -13 && leadng_1.lb1 <= -6) && (dpi_1.lb2 == 1 ||dpi_1.lb2 == 2 || dpi_1.lb2 >= 6 && dpi_1.lb2 <= 13))
				{
					deltr0 = rppmax;
					goto L2699;
				}
				else if ((dpi_1.lb2 == -1 || dpi_1.lb2 == -2 || dpi_1.lb2 >= -13 && dpi_1.lb2 <= -6) && (leadng_1.lb1 == 1 ||leadng_1.lb1 == 2 || leadng_1.lb1 >= 6 && leadng_1.lb1 <= 13))
				{
					deltr0 = rppmax;
					goto L2699;
				}
				if (abs(leadng_1.lb1) >= 14 && abs(leadng_1.lb1) <= 17 || abs(dpi_1.lb2) >= 14 &&abs(dpi_1.lb2) <= 17)
				{
					goto L3699;
				}
				...
				if (abs(leadng_1.lb1) >= 40 && abs(leadng_1.lb1) <= 45 || abs(dpi_1.lb2) >= 40 &&abs(dpi_1.lb2) <= 45)
				{
					goto L3699;
				}
			...
			L3699:
				...
				if ((leadng_1.lb1 == 23 || leadng_1.lb1 == 30) && (dpi_1.lb2 == -1 || dpi_1.lb2 == -2 || dpi_1.lb2 >= -13 && dpi_1.lb2 <= -6) || (dpi_1.lb2 == 23 || dpi_1.lb2 ==30) &&(leadng_1.lb1 == -1 || leadng_1.lb1 == -2 ||leadng_1.lb1 >= -13 && leadng_1.lb1 <= -6))
				{
					bmass = .938f;
					if (srt <= bmass + .498f)
					{
				...
				if (leadng_1.lb1 >= -17 && leadng_1.lb1 <= -14 && (dpi_1.lb2 >= 3 && dpi_1.lb2 <= 5) || dpi_1.lb2 >= -17 &&dpi_1.lb2 <= -14 && (leadng_1.lb1 >= 3 && leadng_1.lb1 <= 5))
				{
					nchrg = -100;
					if (leadng_1.lb1 == -15 && (dpi_1.lb2 == 5 || dpi_1.lb2 ==27) ||dpi_1.lb2 == -15 && (leadng_1.lb1 == 5 ||leadng_1.lb1 == 27))
					{
						nchrg = -2;
						bmass = 1.232f;
						goto L110;
					}
					if (leadng_1.lb1 == -15 && (dpi_1.lb2 == 0 || dpi_1.lb2 == 4 || dpi_1.lb2 == 26 || dpi_1.lb2 == 28) ||dpi_1.lb2 == -15 && (leadng_1.lb1 == 0 ||leadng_1.lb1 == 4 || leadng_1.lb1 == 26 ||leadng_1.lb1 == 28) ||(leadng_1.lb1 == -14 ||leadng_1.lb1 == -16) &&(dpi_1.lb2 == 5 ||dpi_1.lb2 == 27) ||(dpi_1.lb2 == -14 ||dpi_1.lb2 == -16) &&(leadng_1.lb1 == 5 ||leadng_1.lb1 == 27))
					{
						nchrg = -1;
						bmass = .938f;
						goto L110;
					}
					if (leadng_1.lb1 == -15 && (dpi_1.lb2 == 3 || dpi_1.lb2 ==25) ||dpi_1.lb2 == -15 && (leadng_1.lb1 == 3 ||leadng_1.lb1 == 25) ||leadng_1.lb1 == -17 && (dpi_1.lb2 == 5 || dpi_1.lb2 == 27) || dpi_1.lb2 == -17 && (leadng_1.lb1 == 5 || leadng_1.lb1 == 27) || (leadng_1.lb1 == -14 || leadng_1.lb1 == -16) && (dpi_1.lb2 == 0 || dpi_1.lb2 == 4 || dpi_1.lb2 == 26 || dpi_1.lb2 == 28) || (dpi_1.lb2 == -14 || dpi_1.lb2 == -16) && (leadng_1.lb1 == 0 || leadng_1.lb1 == 4 || leadng_1.lb1 == 26 || leadng_1.lb1 == 28))
					{
						nchrg = 0;
						bmass = .938f;
						goto L110;
					}
					if (leadng_1.lb1 == -17 && (dpi_1.lb2 == 0 || dpi_1.lb2 == 4 || dpi_1.lb2 == 26 || dpi_1.lb2 == 28) ||dpi_1.lb2 == -17 && (leadng_1.lb1 == 0 ||leadng_1.lb1 == 4 || leadng_1.lb1 == 26 ||leadng_1.lb1 == 28) ||(leadng_1.lb1 == -14 ||leadng_1.lb1 == -16) &&(dpi_1.lb2 == 3 ||dpi_1.lb2 == 25) ||(dpi_1.lb2 == -14 ||dpi_1.lb2 == -16) &&(leadng_1.lb1 == 3 ||leadng_1.lb1 == 25))
					{
						nchrg = 1;
						bmass = 1.232f;
					}
				...
				if ((leadng_1.lb1 == 21 || leadng_1.lb1 == -30) && (dpi_1.lb2 >= 14 && dpi_1.lb2 <= 17) || (dpi_1.lb2 == 21 ||dpi_1.lb2 == -30) &&(leadng_1.lb1 >= 14 &&leadng_1.lb1 <= 17))
				{
					kp = 0;
					goto L3455;
				}
				if ((leadng_1.lb1 == 23 || leadng_1.lb1 == 30) && (dpi_1.lb2 <= -14 && dpi_1.lb2 >= -17) || (dpi_1.lb2 == 23 ||dpi_1.lb2 == 30) &&(leadng_1.lb1 <= -14 &&leadng_1.lb1 >= -17))
				{
					kp = 1;
					goto L3455;
				}
				if ((leadng_1.lb1 == 21 || leadng_1.lb1 == -30) && (dpi_1.lb2 == 40 || dpi_1.lb2 == 41) || (dpi_1.lb2 == 21 ||dpi_1.lb2 == -30) &&(leadng_1.lb1 == 40 ||leadng_1.lb1 == 41))
				{
					kp = 0;
					goto L3455;
				}
				if ((leadng_1.lb1 == 23 || leadng_1.lb1 == 30) && (dpi_1.lb2 == -40 || dpi_1.lb2 == -41) || (dpi_1.lb2 == 23 ||dpi_1.lb2 == 30) &&(leadng_1.lb1 == -40 ||leadng_1.lb1 == -41))
				{
					kp = 1;
					goto L3455;
				}
				kp = 3;
				if ((leadng_1.lb1 >= 3 && leadng_1.lb1 <= 5 || leadng_1.lb1 ==0) &&(abs(dpi_1.lb2) == 40 || abs(dpi_1.lb2) == 41) ||(dpi_1.lb2 >= 3 && dpi_1.lb2 <= 5 || dpi_1.lb2 ==0) &&(abs(leadng_1.lb1) == 40 || abs(leadng_1.lb1) ==41))
				{
					goto L3455;
				}
				...
				if (leadng_1.lb1 == 21 && (dpi_1.lb2 >= -17 && dpi_1.lb2 <=-14))
				{
					goto L5699;
				}
				if (dpi_1.lb2 == 21 && (leadng_1.lb1 >= -17 && leadng_1.lb1 <=-14))
				{
					goto L5699;
				}
				if ((leadng_1.lb1 == 1 || leadng_1.lb1 == 2 || leadng_1.lb1 >= 6 && leadng_1.lb1 <= 13) && (dpi_1.lb2 >= -17 &&dpi_1.lb2 <= -14) ||(dpi_1.lb2 == 1 || dpi_1.lb2 == 2 || dpi_1.lb2 >= 6 && dpi_1.lb2 <= 13) && (leadng_1.lb1 >= -17 && leadng_1.lb1 <= -14))
				{
					goto L5999;
				}
				if ((leadng_1.lb1 == -1 || leadng_1.lb1 == -2 || leadng_1.lb1 <= -6 && leadng_1.lb1 >= -13) && (dpi_1.lb2 >= 14 &&dpi_1.lb2 <= 17) ||(dpi_1.lb2 == -1 || dpi_1.lb2 == -2 || dpi_1.lb2 <= -6 && dpi_1.lb2 >= -13) && (leadng_1.lb1 >= 14 && leadng_1.lb1 <= 17))
				{
					goto L5999;
				}
				...
				if ((leadng_1.lb1 == 23 || leadng_1.lb1 == 21 || abs(leadng_1.lb1) == 30) && (dpi_1.lb2 >= 25 && dpi_1.lb2 <= 28) || (dpi_1.lb2 == 23 || dpi_1.lb2 == 21 || abs(dpi_1.lb2) == 30) && (leadng_1.lb1 >= 25 &&leadng_1.lb1 <= 28))
				{
					goto L8799;
				}

				if (abs(leadng_1.lb1) == 30 && (dpi_1.lb2 >= 3 && dpi_1.lb2 <= 5) ||abs(dpi_1.lb2) == 30 && (leadng_1.lb1 >= 3 &&leadng_1.lb1 <= 5))
				{
					goto L8799;
				}

				if (leadng_1.lb1 == 29 && (dpi_1.lb2 == 1 || dpi_1.lb2 == 2 ||dpi_1.lb2 >= 6 && dpi_1.lb2 <= 9) ||dpi_1.lb2 == 29 && (leadng_1.lb1 == 1 || leadng_1.lb1 == 2 ||leadng_1.lb1 >= 6 && leadng_1.lb1 <= 9))
				{
					goto L7222;
				}

				if (leadng_1.lb1 == 29 && (dpi_1.lb2 >= 3 && dpi_1.lb2 <= 5 || dpi_1.lb2 >= 21 && dpi_1.lb2 <= 28 || abs(dpi_1.lb2) == 30) ||dpi_1.lb2 == 29 && (leadng_1.lb1 >= 3 &&leadng_1.lb1 <= 5 ||leadng_1.lb1 >= 21 &&leadng_1.lb1 <= 28 |abs(leadng_1.lb1) == 30))
				{
					goto L7444;
				}

				if ((abs(leadng_1.lb1) >= 14 && abs(leadng_1.lb1) <= 17 ||abs(leadng_1.lb1) >= 40) &&(dpi_1.lb2 >= 25 &&dpi_1.lb2 <= 29 || dpi_1.lb2 == 0))
				{
					goto L888;
				}
				if ((abs(dpi_1.lb2) >= 14 && abs(dpi_1.lb2) <= 17 || abs(dpi_1.lb2) >= 40) &&(leadng_1.lb1 >= 25 &&leadng_1.lb1 <= 29 ||leadng_1.lb1 == 0))
				{
					goto L888;
				}

				if ((leadng_1.lb1 == 23 || leadng_1.lb1 == 30) && (dpi_1.lb2 == 1 || dpi_1.lb2 == 2 || dpi_1.lb2 >= 6 && dpi_1.lb2 <= 13) || (dpi_1.lb2 == 23 || dpi_1.lb2 == 30) && (leadng_1.lb1 == 1 || leadng_1.lb1 == 2 ||leadng_1.lb1 >= 6 && leadng_1.lb1 <= 13))
				{
					goto L888;
				}
				if ((leadng_1.lb1 == 21 || leadng_1.lb1 == -30) && (dpi_1.lb2 == -1 || dpi_1.lb2 == -2 || dpi_1.lb2 >= -13 && dpi_1.lb2 <= -6) || (dpi_1.lb2 == 21 || dpi_1.lb2 ==-30) &&(leadng_1.lb1 == -1 || leadng_1.lb1 == -2 ||leadng_1.lb1 >= -13 && leadng_1.lb1 <= -6))
				{
					goto L888;
				}
				...
				if ((dpi_1.lb2 == 23 || dpi_1.lb2 == 21) && (leadng_1.lb1 >=3 &&leadng_1.lb1 <= 5))
				{
					goto L889;
				}
				...
				if ((leadng_1.lb1 == 1 || leadng_1.lb1 == 2) && (dpi_1.lb2 >5 &&dpi_1.lb2 <= 13))
				{
					goto L44;
				}
				if ((dpi_1.lb2 == 1 || dpi_1.lb2 == 2) && (leadng_1.lb1 > 5 &&leadng_1.lb1 <= 13))
				{
					goto L44;
				}
				if ((leadng_1.lb1 == -1 || leadng_1.lb1 == -2) && (dpi_1.lb2 <-5 &&dpi_1.lb2 >= -13))
			...
			L547:
				if (leadng_1.lb1 * dpi_1.lb2 == 0)
				{
					...
					if ((i__4 = ee_1.lb[i1 - 1], abs(i__4)) >= 6 && (i__5 = ee_1.lb[i1 - 1],abs(i__5)) <= 13 ||(i__6 =ee_1.lb[i2 - 1],abs(i__6)) >= 6 &&(i__7 =ee_1.lb[i2 - 1],abs(i__7)) <= 13)
					{
						xeta = 0.f;
					}
					...
					py1cm = pcy;
					pz1cm = pcz;
					distce_(&i1, &i2, &deltre, &dse, &input1_1.dt, &ece, &srt,&ic, &pcx, &pcy, &pcz);
			...
			L3:
				...
				if ((leadng_1.lb1 == 4 || dpi_1.lb2 == 4) && ((i__4 =leadng_1.lb1 * dpi_1.lb2,abs(i__4)) == 4 ||(i__5 =leadng_1.lb1 * dpi_1.lb2, abs(i__5)) == 8))
				{
					xmax = 50.f;
			...
			L31:
				...
				if (abs(leadng_1.lb1) >= 10 && abs(leadng_1.lb1) <= 13 || abs(dpi_1.lb2) >= 10 &&abs(dpi_1.lb2) <= 13)
				{
					xreab = 0.f;
				}
				xkaon = xkaon0 + xreab;
				if (abs(leadng_1.lb1) > 9 && abs(leadng_1.lb1) <= 13 || abs(dpi_1.lb2) > 9 &&abs(dpi_1.lb2) <= 13)
				{
					xnelas = 1.f;
				}
				else
				{
					xnelas = dpion_(&leadng_1.em1, &dpi_1.em2, &leadng_1.lb1,&dpi_1.lb2, &srt);
				}
				icheck = 2;
			L34:
				ds = sqrt((xnelas + xkaon + xphi) / 3.1415926f);
				deltar = ds + .1f;
				distce_(&i1, &i2, &deltar, &ds, &input1_1.dt, &ec, &srt, &ic,&pcx, &pcy, &pcz);
				kkk_1.ekaon[iss * 7 + 3] += 1;
				if (icheck == 2)
				{
			...
			L97:
				if (resona == 0.f)
				{
					...
					if (leadng_1.lb1 * dpi_1.lb2 == 10 && (leadng_1.lb1 == 5 || dpi_1.lb2 == 5) || leadng_1.lb1 * dpi_1.lb2 ==-6 &&(leadng_1.lb1 == 3 || dpi_1.lb2 == 3))
					{
						ee_1.lb[i__ - 1] = 11;
						goto L303;
					}
			...
			L99:
				...
				if (ee_1.lb[i1 - 1] * ee_1.lb[i2 - 1] == 10 && (ee_1.lb[i1 -1] == 5 ||ee_1.lb[i2 - 1] == 5) ||
					ee_1.lb[i1 - 1] *ee_1.lb[i2 - 1] ==-6 &&(ee_1.lb[i1 - 1] == 3 ||ee_1.lb[i2 - 1] == 3))
				{
					ee_1.lb[i__ - 1] = 8;
					goto L305;
				}
				...
				if (ee_1.lb[i1 - 1] * ee_1.lb[i2 - 1] == 6 && (ee_1.lb[i1 - 1] == 3 || ee_1.lb[i2 - 1] == 3) || ee_1.lb[i1 - 1] *ee_1.lb[i2 - 1] ==-10 &&(ee_1.lb[i1 - 1] == 5 ||ee_1.lb[i2 - 1] == 5))
				{
					ee_1.lb[i__ - 1] = 6;
				}
			L305:
			...
			L889:
				...
				ec = r__1 * r__1;
				r__1 = srt - .895f;
				spika = 60.f / (r__1 * r__1 * 4.f / .0025000000000000005f +1.f);
			...
			L33:
				...
				{
					xelstc = erhon_(&leadng_1.em1, &dpi_1.em2, &leadng_1.lb1,&dpi_1.lb2, &srt);
				}
				...
				ichann = 0;
				xphi = 0.f;
				if (((leadng_1.lb1 >= 1 && leadng_1.lb1 <= 2 || leadng_1.lb1 >= 6 && leadng_1.lb1 <= 9) && (dpi_1.lb2 >= 25 &&dpi_1.lb2 <= 27) ||(dpi_1.lb2 >= 1 && dpi_1.lb2 <= 2 || dpi_1.lb2 >= 6 && dpi_1.lb2 <= 9) && (leadng_1.lb1 >= 25 && leadng_1.lb1 <= 27)) &&srt > 1.958f)
				{
					pibphi_(&srt, &leadng_1.lb1, &dpi_1.lb2, &leadng_1.em1, &dpi_1.em2, &xphi, &xphin);
				}
			...
			L4:
				...
				else
				{
					...
					if (zet[ee_1.lb[i1 - 1] + 45] == 0.f && zet[ee_1.lb[i2 -1] +45] == 0.f)
					{
						sig = xpp_(&srt);
					}
			...
			L778:
				...
				if ((leadng_1.lb1 == 0 || leadng_1.lb1 >= 3 && leadng_1.lb1 <=5) &&(dpi_1.lb2 >= 25 && dpi_1.lb2 <= 28) ||(dpi_1.lb2 == 0 || dpi_1.lb2 >= 3 && dpi_1.lb2 <= 5) &&(leadng_1.lb1 >= 25 && leadng_1.lb1 <= 28))
				{
					ppink = 0.f;
					if (srt >= 1.393f)
					{
				...
				if (srt > ppbmas_1.thresh[0])
				{
					...
					else if (leadng_1.lb1 >= 3 && leadng_1.lb1 <= 5 && dpi_1.lb2 >= 25 && dpi_1.lb2 <= 27 ||dpi_1.lb2 >=3 &&dpi_1.lb2 <= 5 && leadng_1.lb1 >= 25 &&leadng_1.lb1 <= 27)
					{
						ppb1_1.ppinnb = prbbar_(&srt);
					}
					else if (leadng_1.lb1 >= 25 && leadng_1.lb1 <= 27 &&dpi_1.lb2 >= 25 && dpi_1.lb2 <= 27)
					{
						ppb1_1.ppinnb = rrbbar_(&srt);
					}
					else if (leadng_1.lb1 >= 3 && leadng_1.lb1 <= 5 &&dpi_1.lb2 == 28 ||dpi_1.lb2 >= 3 && dpi_1.lb2 <= 5 && leadng_1.lb1 == 28)
					{
						ppb1_1.ppinnb = pobbar_(&srt);
					}
					else if (leadng_1.lb1 >= 25 && leadng_1.lb1 <= 27 &&dpi_1.lb2 == 28 ||dpi_1.lb2 >= 25 && dpi_1.lb2 <= 27 && leadng_1.lb1 == 28)
					{
				...
				ppin = ppink + ppb1_1.ppinnb + ppmm_1.pprr + ppmm_1.ppee +ppmm_1.pppe + ppmm_1.rpre + ppmm_1.xopoe +ppmm_1.rree;
				dspp = sqrt((ppel + ppin) / 31.4f);
				dsppr = dspp + .1f;
				distce_(&i1, &i2, &dsppr, &dspp, &input1_1.dt, &ec, &srt, &ic,&px1cm, &py1cm, &pz1cm);
				kkk_1.ekaon[iss * 7 + 4] += 1;
				crpp_(&px1cm, &py1cm, &pz1cm, &srt, &i1, &i2, &iblock, &ppel,&ppin, &spprho, &ipp);
				if (iblock == 666)
				{
					goto L555;
				}
			...
			L3555:
				...
				dskk0 = dskk + .1f;
				distce_(&i1, &i2, &dskk0, &dskk, &input1_1.dt, &ec, &srt, &ic,&px1cm, &py1cm, &pz1cm);
				crlaba_(&px1cm, &py1cm, &pz1cm, &srt, &brel, &brsgm, &i1, &i2,nt, &iblock, &nchrg, &icase);
				leadng_1.em1 = cc_1.e[i1 - 1];
				dpi_1.em2 = cc_1.e[i2 - 1];
				goto L440;
			...
			L7222:
				...
				dskk0 = dskk + .1f;
				distce_(&i1, &i2, &dskk0, &dskk, &input1_1.dt, &ec, &srt, &ic,&px1cm, &py1cm, &pz1cm);
				crphib_(&px1cm, &py1cm, &pz1cm, &srt, &i1, &i2, &xsk1, &xsk2,&xsk3, &xsk4, &xsk5, &sigp, &iblock);
				leadng_1.em1 = cc_1.e[i1 - 1];
				dpi_1.em2 = cc_1.e[i2 - 1];
				goto L440;
			...
			L7799:
				...
				dshnr = dshn + .1f;
				distce_(&i1, &i2, &dshnr, &dshn, &input1_1.dt, &ec, &srt, &ic,&px1cm, &py1cm, &pz1cm);
			...
			L8799:
				...
				r__1 = leadng_1.em1 + dpi_1.em2 + .02f;
				ec = r__1 * r__1;
				crksph_(&px1cm, &py1cm, &pz1cm, &ec, &srt, &emm1, &emm2, &lbp1, &lbp2, &i1, &i2, &ikkg, &ikkl, &iblock, &icase,&c_b102);
				if (icase == 0)
				{
					iblock = 0;
				}
			...
			L888:
				...
				dsknr = dskn + .1f;
				distce_(&i1, &i2, &dsknr, &dskn, &input1_1.dt, &ec, &srt, &ic,&px1cm, &py1cm, &pz1cm);
		...
		for (n = n0 + 1; n <= i__2; ++n)
		{
			...
			{
				++nn_1.nnn;
				pa_1.rpion[(nn_1.nnn + irun * 150001) * 3 - 450006] =aa_1.r__[n * 3 - 3];
				pa_1.rpion[(nn_1.nnn + irun * 150001) * 3 - 450005] =aa_1.r__[n * 3 - 2];
				pa_1.rpion[(nn_1.nnn + irun * 150001) * 3 - 450004] =aa_1.r__[n * 3 - 1];
				if (*nt == *ntmax)
				{
...
int cms_(int *i1, int *i2, float *px1cm, float *py1cm,float *pz1cm, float *srt)
{
	float r__1, r__2, r__3, r__4;
	double sqrt(double);
	static float s, e1, e2, em1, em2, px1, py1, pz1, px2, py2, pz2, p1beta,etotal, transf;
...
int distce_(int *i1, int *i2, float *deltar, float *ds,float *dt, float *ec, float *srt, int *ic, float *px1cm, float *py1cm,float *pz1cm)
{
	float r__1, r__2, r__3, r__4;
	double sqrt(double);
	static float s, e2, x1, y1, z1, x2, y2, z2, px2, py2, pz2, bbb, ddd, dzz,drcm, dxcm, dycm, dzcm, prcm, p1beta, drbeta, relvel, rsqare,transf;
	...
	*ic = 0;
	...
	e2 = sqrt(r__1 * r__1 + r__2 * r__2 + r__3 * r__3 + r__4 * r__4);
	s = *srt * *srt;
	p1beta = leadng_1.px1 * bg_1.betax + leadng_1.py1 * bg_1.betay +leadng_1.pz1 * bg_1.betaz;
	transf = bg_1.gamma * (bg_1.gamma * p1beta / (bg_1.gamma + 1) -leadng_1.e1);
	r__1 = *px1cm;
	r__2 = *py1cm;
	r__3 = *pz1cm;
...
int crnn_(int *irun, float *px, float *py, float *pz, float *srt, int *i1, int *i2, int *iblock, int *ntag, float *signn, float *sig, int *nt, int *ipert1)
{
	...
	extern int bbdangle_(float *, float *, float *, int *,int *, int *, int *, float *, float *, int *);
	...
	static int id1;
	static float ct1, ct2, pr2, st1, px3, py3, pz3, px4, py4, pz4, pz2, st2,ada;
	...
	extern int ddp2_(float *, int *, float *, float *, float *, float *, float *, float *, float *, float *, float *, float *, float *,int *);
	...
	extern int sbbdm_(float *, float *, int *, int *,float *, float *);
	extern double omega_(float *), sigma_(float *, int *, int *,int *);
	extern int ddrho_(float *, int *, float *, float *,float *, float *, float *, float *, float *, float *, float *, float *,float *, float *, int *);
	static int ianti;
	static float pmdlk, signd, amrho, pmdsk;
	extern double pplpk_(float *);
	static float pmnsk;
	extern int pprho_(float *, int *, float *, float *,float *, float *, float *, float *, float *, float *, float *, float *,float *, float *, int *);
	static float xmass, p1beta, p2beta, e2picm, dprob1, pmdlk2, pmdsk2, pmnsk2,aomega;
	extern int bbkaon_(int *, float *, float *, float *,float *, float *, float *, float *, float *, float *, float *, float *,float *, int *);
	static float pfinal;
	extern int rmasdd_(float *, float *, float *, float *, float *, int *, int *, float *, float *);
	static float somega, ppbeta, xfinal;
	extern int ppomga_(float *, int *, float *, float *,float *, float *, float *, float *, float *, float *, float *, float *,float *, int *);
	extern double ranart_(int *);
	...
	*ntag = 0;
	...
	L222:
			...
			dpi_1.lb2 <= 2 && (leadng_1.lb1 <= 17 && leadng_1.lb1 >= 14))
		{
			...
			if (ranart_(&rndf77_1.nseed) <= sigk / (sigk + x1535 + sig4 +sig2 + sig1 + s4pi + srho + somega))
			{
				goto L306;
			}
			if (ranart_(&rndf77_1.nseed) <= s4pi / (x1535 + sig4 + sig2 +sig1 + s4pi + srho + somega))
			{
				ntry1 = 0;
			}
			if (ranart_(&rndf77_1.nseed) <= srho / (x1535 + sig4 + sig2 +sig1 + srho + somega))
			{
				ntry1 = 0;
			}
			if (ranart_(&rndf77_1.nseed) <= somega / (x1535 + sig4 + sig2 +sig1 + somega))
			{
				goto L309;
			}
			if (ranart_(&rndf77_1.nseed) <= x1535 / (sig1 + sig2 + sig4 +x1535))
			{
				n12 = 9;
			}
			else
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 2 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 2)
		{
			...
			if (ranart_(&rndf77_1.nseed) <= x1535 / (x1535 + sig1 + sig2 +sig4))
			{
				n12 = 10;
			}
			else
		...
		if (ee_1.lb[*i1 - 1] * ee_1.lb[*i2 - 1] == 2)
		{
			...
			sig1 = sigma_(srt, &c__1, &c__1, &c__1) * .5f + sigma_(srt, &c__1,&c__1, &c__0) *.25f;
			if (input_1.nstar == 1)
			{
			...
			if (ranart_(&rndf77_1.nseed) <= srho / (signd - sig3 - sigk -s4pi))
			{
				ntry1 = 0;
			}
			if (ranart_(&rndf77_1.nseed) <= somega / (signd - sig3 - sigk -s4pi - srho))
			{
				goto L309;
			}
			if (ranart_(&rndf77_1.nseed) < x1535 / (sig1 + sig2 + x1535 +sig4 * .5f))
			{
				n12 = 11;
			...
			{
				if (ranart_(&rndf77_1.nseed) <= sig4 / (sig4 + (sig1 + sig2) *2.f))
				{
					n12 = 68;
					goto L1014;
				}
...
L205:
	...
	*iblock = 4;
	...
	pb_1.ppion[(nn_1.nnn + *irun * 150001) * 3 - 450006] = bg_1.betax *transf +ppx;
	pb_1.ppion[(nn_1.nnn + *irun * 150001) * 3 - 450005] = bg_1.betay *transf +ppy;
	pb_1.ppion[(nn_1.nnn + *irun * 150001) * 3 - 450004] = bg_1.betaz * transf +ppz;
	dpert_1.dppion[nn_1.nnn + *irun * 150001 - 150002] = dpert_1.dpertp[*i1 -1] *dpert_1.dpertp[*i2 - 1];
...
L108:
	...
	for (idloop = 1; idloop <= i__1; ++idloop)
	{
		...
		transf = bg_1.gamma * (bg_1.gamma * p1dbeta / (bg_1.gamma + 1.f) +e1dcm);
		...
		else
		{
			...
			if (para8_1.idpert == 2 && idloop == ndloop)
			{
				...
				{
					++nn_1.nnn;
					pb_1.ppion[(nn_1.nnn + *irun * 150001) * 3 - 450006] =ppd[ipertd * 3 - 3];
					pb_1.ppion[(nn_1.nnn + *irun * 150001) * 3 - 450005] =ppd[ipertd * 3 - 2];
					pb_1.ppion[(nn_1.nnn + *irun * 150001) * 3 - 450004] =ppd[ipertd * 3 - 1];
					pc_1.epion[nn_1.nnn + *irun * 150001 - 150002] = 1.8756f;
					pd_1.lpion[nn_1.nnn + *irun * 150001 - 150002] = lbpd[ipertd - 1];
					pa_1.rpion[(nn_1.nnn + *irun * 150001) * 3 - 450006] =aa_1.r__[*i1 * 3 - 3];
					pa_1.rpion[(nn_1.nnn + *irun * 150001) * 3 - 450005] =aa_1.r__[*i1 * 3 - 2];
					pa_1.rpion[(nn_1.nnn + *irun * 150001) * 3 - 450004] =a_1.r__[*i1 * 3 - 1];
					dpert_1.dppion[nn_1.nnn + *irun * 150001 - 150002] = 1.f /(float)para8_1.npertd;
				}
			}
		}
	}
...
int crpp_(float *px, float *py, float *pz, float *srt, int *i1, int *i2, int *iblock, float *ppel, float *ppin, float *spprho, int *ipp)
{
	...
	extern int pi2et2_(int *, int *, int *,int *, float *, float *, int *, int *);
	static float ranpi;
	extern int pi2ro2_(int *, int *, int *,int *, float *, float *, int *, int *),ro2et2_(int *,int *, int *, int *, float *, float *, int *,int *),pi3eta_(int *, int *, int *, int *,float *, float *, int *, int *),bbarfs_(int *, int *, float *, float *, int *, int *);
	extern double ranart_(int *);
	...
	*iblock = 1;
	if (*srt > .996f && *ppin / (*ppin + *ppel) > ranart_(&rndf77_1.nseed))
	{
		...
		else if ((ppmm_1.pprr + ppmm_1.ppee + ppmm_1.pppe + ppmm_1.rpre +ppmm_1.xopoe) / *ppin >=ranpi)
		{
			opioet_(i1, i2, &lbb1, &lbb2, &ei1, &ei2, iblock, &input1_1.iseed);
		}
		else if ((ppmm_1.pprr + ppmm_1.ppee + ppmm_1.pppe + ppmm_1.rpre +ppmm_1.xopoe + ppmm_1.rree) / *ppin >=ranpi)
		{
			ro2et2_(i1, i2, &lbb1, &lbb2, &ei1, &ei2, iblock, &input1_1.iseed);
		}
		else if ((ppmm_1.pprr + ppmm_1.ppee + ppmm_1.pppe + ppmm_1.rpre +ppmm_1.xopoe + ppmm_1.rree + ppb1_1.ppinnb) / *ppin >=ranpi)
		{
		...
		else
		{
			*iblock = 66;
			...
			lb1 = ee_1.lb[*i1 - 1];
			lb2 = ee_1.lb[*i2 - 1];
			if ((lb1 == 0 || lb1 >= 3 && lb1 <= 5) && (lb2 >= 25 && lb2 <= 28) || (lb2 == 0 || lb2 >= 3 && lb2 <= 5) && (lb1 >= 25 &&lb1 <= 28))
			{
				ei1 = .895f;
				ei2 = .498f;
				if (ranart_(&rndf77_1.nseed) >= .5f)
...
int crnd_(int *irun, float *px, float *py, float *pz, float *srt, int *i1, int *i2, int *iblock, float *signn, float *sig, float *sigk, float *xsk1, float *xsk2, float *xsk3, float *xsk4, float *xsk5, int *nt, int *ipert1)
{
	...
	extern int sbbdm_(float *, float *, int *, int *,float *, float *);
	extern double sigma_(float *, int *, int *, int *), denom_(float *, float *);
	static int ianti;
	static float signd, sigdn, renom, xmass, p1beta, p2beta, e2picm, dprob1,renom1;
	extern int bbkaon_(int *, float *, float *, float *,float *, float *, float *, float *, float *, float *, float *, float *,float *, int *);
	...
	*iblock = 0;
	...
	if (para8_1.idpert == 1 && *ipert1 == 1)
	{
		...
		else if (((i__1 = ee_1.lb[*i2 - 1], abs(i__1)) == 1 || (i__2 =ee_1.lb[*i2 - 1],abs(i__2)) == 2) &&((i__3 = ee_1.lb[*i1 -1],abs(i__3)) >= 6 &&(i__4 = ee_1.lb[*i1 - 1], abs(i__4)) <= 13))
		{
			goto L108;
		}
		else
	...
	else
	{
		...
		if (ee_1.lb[*i1 - 1] * ee_1.lb[*i2 - 1] == 16 && ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 2 || (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 2))
		{
			...
			if (x1 > (*signn + sigdn + x1440 * 2.f + x1535 * 2.f + *sigk +sdprod) / *sig)
			{
				return 0;
			}
			...
			if (ranart_(&rndf77_1.nseed) < sigdn / (sigdn + x1440 * 2.f +x1535 * 2.f))
			{
				m12 = 1;
				goto L206;
			}
	...
	L13:
		...
		r__2 = *srt;
		r__3 = dm;
		r__1 = (r__2 * r__2 - r__3 * r__3 + .88040689000000005f) / (*srt *2.f);
...
int crdd_(int *irun, float *px, float *py, float *pz, float *srt, int *i1, int *i2, int *iblock, int *ntag, float *signn, float *sig, int *nt, int *ipert1)
{
	int i__1, i__2, i__3, i__4, i__5, i__6;
	float r__1, r__2, r__3, r__4, r__5;
	double sqrt(double), atan2(double, double), exp(double),log(double), cos(double), sin(double);
	extern int bbdangle_(float *, float *, float *, int *,int *, int *, int *, float *, float *, int *);
	static float a, x, c1, c2, s1, t1, t2, s2, x1;
	static int ic;
	static float al;
	...
	static int id1;
	static float am1, am2, pr2, st1, st2, pz2, px3, py3, pz3, px4, py4, pz4,ada, ana;
	...
	extern double ppk0_(float *), ppk1_(float *);
	static float pxi1, pyi1, pzi1, pxi2, pyi2, xsk1, xsk2, xsk3, xsk4, xsk5,pzi2;
	static int lbpd[10000];
	static float epcm, dmin__, dmax__, sigk, pt1i1, pt2i1, pt3i1, pt1i2, pt2i2,pt3i2, e1dcm, xptr, t1dlk, t2dlk;
	static int icou1;
	static float t1dsk, t2dsk, t1nlk, t1nsk, t2nsk;
	static int ntry1, ntry2;
	extern int sbbdm_(float *, float *, int *, int *,float *, float *);
...
int init_(int *minnum, int *maxnum, int *num,float *radius, float *x0, float *z0, float *p0, float *gamma, int *iseed, int *mass, int *iopt)
{
	int i__1, i__2;
	...
	if (*iopt != 3)
	{
		...
		for (irun = 1; irun <= i__1; ++irun)
		{
			...
			for (i__ = *minnum + (irun - 1) * *mass; i__ <= i__2; ++i__)
			{
				for (idir = 1; idir <= 3; ++idir)
				{
					bb_1.p[idir + i__ * 3 - 4] -= ptot[idir - 1] / (float)npart;
				}
				if (*iopt == 1 || *iopt == 2)
				{
					r__1 = bb_1.p[i__ * 3 - 3];
					r__2 = bb_1.p[i__ * 3 - 2];
					r__3 = bb_1.p[i__ * 3 - 1];
					epart = sqrt(r__1 * r__1 + r__2 * r__2 + r__3 * r__3 +.88040689000000005f);
					bb_1.p[i__ * 3 - 1] = *gamma * (bb_1.p[i__ * 3 - 1] +beta * epart);
				}
				else
				{
					bb_1.p[i__ * 3 - 1] += *p0;
...
int dens_(int *ipot, int *mass, int *num,int *nesc)
{
	static float zet[91] = {1.f, 0.f, 0.f, 0.f, 0.f, 1.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
						   0.f, 0.f, 0.f, -1.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f,
						   -1.f, 0.f, 1.f, 0.f, -1.f, 0.f, -1.f, 0.f, -2.f, -1.f, 0.f, 1.f, 0.f, 0.f, 0.f,
	...
	static float s, u;
	static int ix, iy, iz;
	static float big, pxl[82369], pyl[82369],pzl[82369], rho0,denr;
		...
		for (j = 1; j <= i__2; ++j)
		{
			...
			else
			{
				...
				if (zet[ee_1.lb[i__ - 1] + 45] != 0.f)
				{
					...
					dd_1.rhop[ix + (iy - 1 + iz * 41) * 41 + 41184] += small;
					dd_1.rhop[ix + (iy + (iz + 1) * 41) * 41 + 41184] +=small;
					dd_1.rhop[ix + (iy + (iz - 1) * 41) * 41 + 41184] +=small;
					goto L40;
				}
				if (zet[ee_1.lb[i__ - 1] + 45] == 0.f)
				{
					...
					dd_1.rhon[ix + (iy - 1 + iz * 41) * 41 + 41184] += small;
					dd_1.rhon[ix + (iy + (iz + 1) * 41) * 41 + 41184] +=small;
					dd_1.rhon[ix + (iy + (iz - 1) * 41) * 41 + 41184] +=small;
					goto L40;
				}
			L40:
				pxl[ix + (iy + iz * 41) * 41 + 41184] += bb_1.p[i__ * 3 - 3] *big;
				pxl[ix + 1 + (iy + iz * 41) * 41 + 41184] += bb_1.p[i__ * 3 -3] *small;
				pxl[ix - 1 + (iy + iz * 41) * 41 + 41184] += bb_1.p[i__ * 3 -3] *small;
				pxl[ix + (iy + 1 + iz * 41) * 41 + 41184] += bb_1.p[i__ * 3 -3] *small;
				pxl[ix + (iy - 1 + iz * 41) * 41 + 41184] += bb_1.p[i__ * 3 -3] *small;
				pxl[ix + (iy + (iz + 1) * 41) * 41 + 41184] += bb_1.p[i__ * 3 - 3] * small;
				pxl[ix + (iy + (iz - 1) * 41) * 41 + 41184] += bb_1.p[i__ * 3 - 3] * small;
				pyl[ix + (iy + iz * 41) * 41 + 41184] += bb_1.p[i__ * 3 - 2] *big;
				pyl[ix + 1 + (iy + iz * 41) * 41 + 41184] += bb_1.p[i__ * 3 -2] *small;
				pyl[ix - 1 + (iy + iz * 41) * 41 + 41184] += bb_1.p[i__ * 3 -] *small;
				pyl[ix + (iy + 1 + iz * 41) * 41 + 41184] += bb_1.p[i__ * 3 -2] *small;
				pyl[ix + (iy - 1 + iz * 41) * 41 + 41184] += bb_1.p[i__ * 3 -2] *small;
				pyl[ix + (iy + (iz + 1) * 41) * 41 + 41184] += bb_1.p[i__ * 3 - 2] * small;
				pyl[ix + (iy + (iz - 1) * 41) * 41 + 41184] += bb_1.p[i__ * 3 - 2] * small;
				pzl[ix + (iy + iz * 41) * 41 + 41184] += bb_1.p[i__ * 3 - 1] *big;
				pzl[ix + 1 + (iy + iz * 41) * 41 + 41184] += bb_1.p[i__ * 3 -1] *small;
				pzl[ix - 1 + (iy + iz * 41) * 41 + 41184] += bb_1.p[i__ * 3 -1] *small;
				pzl[ix + (iy + 1 + iz * 41) * 41 + 41184] += bb_1.p[i__ * 3 -1] *small;
				pzl[ix + (iy - 1 + iz * 41) * 41 + 41184] += bb_1.p[i__ * 3 -1] *small;
				...
				r__3 = bb_1.p[i__ * 3 - 2];
				r__4 = bb_1.p[i__ * 3 - 1];
				tt_1.pel[ix + (iy + iz * 41) * 41 + 41184] += sqrt(r__1 * r__1 +r__2 * r__2 + r__3 * r__3 + r__4 * r__4) *big;
				r__1 = cc_1.e[i__ - 1];
				r__2 = bb_1.p[i__ * 3 - 3];
				r__3 = bb_1.p[i__ * 3 - 2];
				r__4 = bb_1.p[i__ * 3 - 1];
				tt_1.pel[ix + 1 + (iy + iz * 41) * 41 + 41184] += sqrt(r__1 *r__1 +r__2 * r__2 + r__3 * r__3 + r__4 * r__4) *small;
				r__1 = cc_1.e[i__ - 1];
				r__2 = bb_1.p[i__ * 3 - 3];
				r__3 = bb_1.p[i__ * 3 - 2];
				r__4 = bb_1.p[i__ * 3 - 1];
				...
				r__3 = bb_1.p[i__ * 3 - 2];
				r__4 = bb_1.p[i__ * 3 - 1];
				tt_1.pel[ix + (iy + 1 + iz * 41) * 41 + 41184] += sqrt(r__1 *r__1 +r__2 * r__2 + r__3 * r__3 + r__4 * r__4) *small;
				r__1 = cc_1.e[i__ - 1];
				r__2 = bb_1.p[i__ * 3 - 3];
				r__3 = bb_1.p[i__ * 3 - 2];
				r__4 = bb_1.p[i__ * 3 - 1];
				...
				r__3 = bb_1.p[i__ * 3 - 2];
				r__4 = bb_1.p[i__ * 3 - 1];
				tt_1.pel[ix + (iy + (iz + 1) * 41) * 41 + 41184] += sqrt(r__1 * r__1 + r__2 * r__2 + r__3 * r__3 + r__4 * r__4) *small;
				r__1 = cc_1.e[i__ - 1];
				r__2 = bb_1.p[i__ * 3 - 3];
				r__3 = bb_1.p[i__ * 3 - 2];
				r__4 = bb_1.p[i__ * 3 - 1];
		...
		for (iy = -20; iy <= 20; ++iy)
		{
			for (ix = -20; ix <= 20; ++ix)
			{
				...
				if (*ipot == 1 || *ipot == 6)
				{
                    ...
                    d__1 = (double)(dd_1.rho[ix + (iy + iz * 41) * 41 + 41184] /rho0);
                    d__2 = (double)s;
...
int gradu_(int *iopt, int *ix, int *iy, int *iz, float *gradx, float *grady, float *gradz)
{
	...
	case 1:
		r__1 = rxplus;
        r__2 = rxmins;
        *gradx = (rxplus - rxmins) * -.062f + (r__1 * r__1 - r__2 * r__2) *.03525f;
        r__1 = ryplus;
        r__2 = rymins;
        *grady = (ryplus - rymins) * -.062f + (r__1 * r__1 - r__2 * r__2) *.03525f;
        r__1 = rzplus;r__2 = rzmins;
        *gradz = (rzplus - rzmins) * -.062f + (r__1 * r__1 - r__2 * r__2) *.03525f;
	return 0;
	case 2:
    expnt = 1.3333333f;
	d__1 = (double)rxplus;
	...
	*gradz = -acoef * (rzplus - rzmins) + (pow_dd(&d__1, &d__2) - pow_dd(&d__3, &d__4)) * .1515f;
	...
	else
	{
		...
		d__7 = (double)rxmins;
		d__8 = (double)expnt2;
		*gradx = -acoef1 * (pow_dd(&d__1, &d__2) - pow_dd(&d__3, &d__4)) -acoef2 * (pow_dd(&d__5, &d__6) - pow_dd(&d__7, &d__8));
		d__1 = (double)ryplus;
		d__2 = (double)expnt;
		d__3 = (double)rymins;
		d__4 = (double)expnt;
		...
		d__7 = (double)rymins;
		d__8 = (double)expnt2;
		*grady = -acoef1 * (pow_dd(&d__1, &d__2) - pow_dd(&d__3, &d__4)) -acoef2 * (pow_dd(&d__5, &d__6) - pow_dd(&d__7, &d__8));
		d__1 = (double)rzplus;
		d__2 = (double)expnt;
		d__3 = (double)rzmins;
		d__4 = (double)expnt;
		...
		d__7 = (double)rzmins;
		d__8 = (double)expnt2;
		*gradz = -acoef1 * (pow_dd(&d__1, &d__2) - pow_dd(&d__3, &d__4)) -acoef2 * (pow_dd(&d__5, &d__6) - pow_dd(&d__7, &d__8));
	}
	return 0;
	case 5:
    expnt = 2.77f;
...
int decay_(int *irun, int *i__, int *nnn,int *iseed, float *wid, int *nt)
{
	int i__1;
	static float x3, x4, x5, x6, x8, dm;
	static int lbi, lbm, nlab, nalb;
	static float ctrl;
	extern int dkine_(int *, int *, int *,int *, int *, float *, int *);
	...
	if (*nt == input2_1.ntmax)
	{
		...
		if (lbm == 0 || lbm == 25 || lbm == 26 || lbm == 27)
		{
			...
			pb_1.ppion[(*nnn + *irun * 150001) * 3 - 450006] = bb_1.p[*i__ * 3 -3];
			pb_1.ppion[(*nnn + *irun * 150001) * 3 - 450005] = bb_1.p[*i__ * 3 -2];
			pb_1.ppion[(*nnn + *irun * 150001) * 3 - 450004] = bb_1.p[*i__ * 3 -1];
...
int decay2_(int *irun, int *i__, int *nnn,int *iseed, float *wid, int *nt)
{
	int i__1;

	static float x3, dm;
	static int lbi, nlab;
	extern int dkine2_(int *, int *, int *,int *, int *, float *, int *);
	static int lbanti;
	extern double ranart_(int *);
...
int dkine2_(int *irun, int *i__, int *nnn,int *nlab, int *iseed, float *wid, int *nt)
{
...
double sigma_(float *srt, int *id, int *ioi, int *iof)
{
	...
	r__6 = am0;
	r__7 = t;
	ret_val = .12233087920268615f / (p2 * 2.f) * alfa * pow_dd(&d__1, &d__2) *(r__1 * r__1) * (r__2 * r__2) * (r__3 * (r__3 * r__3)) / (r__4 * r__4 + r__6 * r__6 * (r__7 * r__7));
	ret_val *= 10.f;
	if (ret_val == 0.f)
	{
		ret_val = 1e-6f;
...
double denom_(float *srt, float *con)
{
	...
	static float f;
	static int i__;
	static float q, s, a1, p0, p1, q2, dm, tq, am0, amn, amp, sum, amin, amax,avpi;
	static int nmax;
	static float dmass;
...
int m1535_(int *lb1, int *lb2, float *srt, float *x1535)
{
	...
	*x1535 = 0.f;
	...
	if (*lb1 * *lb2 == 10 && (*lb1 == 1 || *lb2 == 1) || *lb1 * *lb2 == 22 &&(*lb1 == 2 || *lb2 == 2))
	{
		*x1535 = sigma * 3.f;
	}
	return 0;
...
int n1535_(int *lb1, int *lb2, float *srt, float *x1535)
{
	...
	*x1535 = 0.f;
	...
	if (*lb1 * *lb2 == 54 && (*lb1 == 6 || *lb2 == 6) || *lb1 * *lb2 == 56 &&(*lb1 == 7 || *lb2 == 7))
	{
		*x1535 = sigma * 3.f;
		return 0;
	}
...
int ddp2_(float *srt, int *iseed, float *px, float *py,float *pz, float *dm1, float *pnx, float *pny, float *pnz, float *dm2, float *ppx, float *ppy, float *ppz, int *icou1)
{
	float r__1, r__2, r__3, r__4, r__5, r__6;
	double sqrt(double), cos(double), sin(double);
	static float v, w, x, f00, ga, ek, en, ep, x00, pi, bx, by, bz, pn, pt,pn2, fai, amn, amp, eln, sig, pnt;
	extern double ptr_(float *, int *);
...
L8:
	...
	r__4 = *dm1 - amp - *dm2;
	r__5 = *srt;
	ptmax2 = ((r__1 * r__1 - r__2 * r__2) * (r__3 * r__3 - r__4 * r__4) / 4.f) /(r__5 * r__5);
	if (ptmax2 <= 0.f)
	{
		goto L8;
	}
...
L7:
	...
	r__5 = *srt;
	r__6 = pt;
	pzmax2 = ((r__1 * r__1 - r__2 * r__2) * (r__3 * r__3 - r__4 * r__4) / 4.f) /(r__5 * r__5) -r__6 * r__6;
...
int ddrho_(float *srt, int *iseed, float *px, float *py,float *pz, float *dm1, float *pnx, float *pny, float *pnz, float *dm2, float *ppx, float *ppy, float *ppz, float *amp, int *icou1)
{
	float r__1, r__2, r__3, r__4, r__5, r__6;
	double sqrt(double), cos(double), sin(double);
	static float v, w, x, f00, ga, ek, en, ep, x00, pi, bx, by, bz, pn, pt,pn2, fai, amn, eln, sig, pnt;
	extern double ptr_(float *, int *);
	static float srt1, fain, elnc, xmax, xptr, fmax00, pbeta, ptmax, pzmax;
	static int ntrym, ntryx;
	static float trans0, ptmax2, pzmax2;
...
int pprho_(float *srt, int *iseed, float *px, float *py,float *pz, float *dm1, float *pnx, float *pny, float *pnz, float *dm2, float *ppx, float *ppy, float *ppz, float *amp, int *icou1)
{
	float r__1, r__2, r__3, r__4, r__5, r__6;
	double sqrt(double), cos(double), sin(double);
	static float v, w, x, f00, ga, ek, en, ep, x00, pi, bx, by, bz, pn, pt,pn2, fai, amn, eln, sig, pnt;
...
int ppomga_(float *srt, int *iseed, float *px, float *py,float *pz, float *dm1, float *pnx, float *pny, float *pnz, float *dm2, float *ppx, float *ppy, float *ppz, int *icou1)
{
	float r__1, r__2, r__3, r__4, r__5, r__6;
	double sqrt(double), cos(double), sin(double);
	static float v, w, x, f00, ga, ek, en, ep, x00, pi, bx, by, bz, pn, pt,pn2, fai, amn, amp, eln, sig, pnt;
...
{
	static float earray[15] = {2.23f, 2.81f, 3.67f, 4.f, 4.95f, 5.52f, 5.97f, 6.04f,6.6f, 6.9f, 7.87f, 8.11f, 10.01f, 16.f, 19.f};
	static float xarray[15] = {1.22f, 2.51f, 2.67f, 2.95f, 2.96f, 2.84f, 2.8f, 3.2f,2.7f, 3.f, 2.54f, 2.46f, 2.4f, 1.66f, 1.5f};
	float ret_val, r__1, r__2, r__3, r__4;
	double sqrt(double), log(double), exp(double);
	static int ie;
...
{
	static float xarray[12] = {.02f, .4f, 1.15f, 1.6f, 2.19f, 2.85f, 2.3f, 3.1f,2.47f, 2.6f, 2.4f, 1.7f};
	static float earray[12] = {2.23f, 2.81f, 3.67f, 4.f, 4.95f, 5.52f, 5.97f, 6.04f,6.6f, 6.9f, 10.01f, 19.f};
	float ret_val, r__1, r__2, r__3, r__4;
	double sqrt(double), log(double), exp(double);
	static int ie;
	static float plab, xmin, ymin, xmax, ymax, pmass;
...
{
	static float xarray[12] = {.02f, .22f, .74f, 1.1f, 1.76f, 1.84f, 2.2f, 2.4f,2.15f, 2.6f, 2.3f, 1.7f};
	static float earray[12] = {2.23f, 2.81f, 3.67f, 4.f, 4.95f, 5.52f, 5.97f, 6.04f,6.6f, 6.9f, 10.01f, 19.f};
	float ret_val, r__1, r__2, r__3, r__4;
	double sqrt(double), log(double), exp(double);
	static int ie;
...
int ppxs_(int *lb1, int *lb2, float *srt, float *ppsig,float *spprho, int *ipp)
{
	float r__1, r__2;
	double sqrt(double), atan(double), sin(double);
	static float q, s0, s1, s2, d00, d11, d20, erh, esi, erho, trho, esigma,tsigma;
	...
	*iblock = 1;
	...
	else
	{
		...
		if (*iblock == 77)
		{
			...
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 1 && ee_1.lb[*i2 - 1] == 4 || ee_1.lb[*i1 - 1] == 4 && (i__2 = ee_1.lb[*i2 - 1],abs(i__2)) == 1)
			{
				if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 1)
				{
					ii = *i1;
			...
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 2 && ee_1.lb[*i2 - 1] == 4 || ee_1.lb[*i1 - 1] == 4 && (i__2 = ee_1.lb[*i2 - 1],abs(i__2)) == 2)
			{
				if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 2)
				{
					ii = *i1;
		...
		if (*iblock == 78)
		{
			rmasdd_(srt, &c_b185, &c_b503, &c_b187, &c_b505, &input1_1.iseed,&c__4, &dm, &ameson);
			arho = ameson;
			if (ee_1.lb[*i1 - 1] == 1 && ee_1.lb[*i2 - 1] == 5 || ee_1.lb[*i1 - 1] == 5 && ee_1.lb[*i2 - 1] == 1 || (ee_1.lb[*i1 - 1] == -1 && ee_1.lb[*i2 - 1] == 3 || ee_1.lb[*i1 - 1] == 3 && ee_1.lb[*i2 - 1] == -1))
			{
				if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 1)
	...
	*iblock = 1;
	...
	else
	{
		...
		*iblock = 80;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 7 && ee_1.lb[*i2 - 1] ==4 ||ee_1.lb[*i1 - 1] == 4 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 7)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 7)
			{
				ii = *i1;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 8 && ee_1.lb[*i2 - 1] ==4 ||ee_1.lb[*i1 - 1] == 4 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 8)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 8)
			{
				ii = *i1;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 6 && ee_1.lb[*i2 - 1] ==4 ||ee_1.lb[*i1 - 1] == 4 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 6)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 6)
			{
				ii = *i1;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 9 && ee_1.lb[*i2 - 1] ==4 ||ee_1.lb[*i1 - 1] == 4 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 9)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 9)
			{
				ii = *i1;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 10 && ee_1.lb[*i2 - 1] ==4 ||ee_1.lb[*i1 - 1] == 4 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 10 ||ee_1.lb[*i1 - 1] == 4 && (i__3 = ee_1.lb[*i2 - 1], abs(i__3)) == 12 || ee_1.lb[*i2 - 1] == 4 && (i__4 = ee_1.lb[*i1 - 1], abs(i__4)) == 12)
		{
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 11 && ee_1.lb[*i2 - 1] ==4 ||ee_1.lb[*i1 - 1] == 4 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 11 ||ee_1.lb[*i1 - 1] == 4 && (i__3 = ee_1.lb[*i2 - 1], abs(i__3)) == 13 || ee_1.lb[*i2 - 1] == 4 && (i__4 = ee_1.lb[*i1 - 1], abs(i__4)) == 13)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 11 || (i__2 = ee_1.lb[*i1 - 1], abs(i__2)) == 13)
			{
				ii = *i1;
	...
	*iblock = 1;
	...
	else
	{
		...
		*iblock = 81;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 7 && ee_1.lb[*i2 - 1] ==26 ||ee_1.lb[*i1 - 1] == 26 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 7)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 7)
			{
				ii = *i1;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 8 && ee_1.lb[*i2 - 1] ==26 ||
			ee_1.lb[*i1 - 1] == 26 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 8)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 8)
			{
				ii = *i1;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 6 && ee_1.lb[*i2 - 1] ==26 ||ee_1.lb[*i1 - 1] == 26 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 6)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 6)
			{
				ii = *i1;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 9 && ee_1.lb[*i2 - 1] ==26 ||ee_1.lb[*i1 - 1] == 26 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 9)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 9)
			{
				ii = *i1;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 10 && ee_1.lb[*i2 - 1] ==26 ||ee_1.lb[*i1 - 1] == 26 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 10 ||ee_1.lb[*i1 - 1] == 26 && (i__3 = ee_1.lb[*i2 - 1], abs(i__3)) == 12 || ee_1.lb[*i2 - 1] == 26 && (i__4 = ee_1.lb[*i1 - 1], abs(i__4)) == 12)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 10 || (i__2 = ee_1.lb[*i1 - 1], abs(i__2)) == 12)
			{
				ii = *i1;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 11 && ee_1.lb[*i2 - 1] ==26 ||ee_1.lb[*i1 - 1] == 26 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 11 ||ee_1.lb[*i1 - 1] == 26 && (i__3 = ee_1.lb[*i2 - 1], abs(i__3)) == 13 || ee_1.lb[*i2 - 1] == 26 && (i__4 = ee_1.lb[*i1 - 1], abs(i__4)) == 13)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 11 || (i__2 = ee_1.lb[*i1 - 1], abs(i__2)) == 13)
			{
				ii = *i1;
	...
	L60:
		*iblock = 82;
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 7 && ee_1.lb[*i2 - 1] ==28 ||ee_1.lb[*i1 - 1] == 28 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 7)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 7)
			{
				ii = *i1;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 8 && ee_1.lb[*i2 - 1] ==28 ||ee_1.lb[*i1 - 1] == 28 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 8)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 8)
			{
				ii = *i1;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 6 && ee_1.lb[*i2 - 1] ==28 ||ee_1.lb[*i1 - 1] == 28 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 6)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 6)
			{
				ii = *i1;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 9 && ee_1.lb[*i2 - 1] ==28 ||ee_1.lb[*i1 - 1] == 28 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 9)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 9)
			{
				ii = *i1;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 10 && ee_1.lb[*i2 - 1] ==28 ||ee_1.lb[*i1 - 1] == 28 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 10 ||ee_1.lb[*i1 - 1] == 28 && (i__3 = ee_1.lb[*i2 - 1], abs(i__3)) == 12 || ee_1.lb[*i2 - 1] == 28 && (i__4 = ee_1.lb[*i1 - 1], abs(i__4)) == 12)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 10 || (i__2 = ee_1.lb[*i1 - 1], abs(i__2)) == 12)
			{
				ii = *i1;
		...
		if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 11 && ee_1.lb[*i2 - 1] ==28 ||ee_1.lb[*i1 - 1] == 28 && (i__2 = ee_1.lb[*i2 - 1], abs(i__2)) == 11 ||ee_1.lb[*i1 - 1] == 28 && (i__3 = ee_1.lb[*i2 - 1], abs(i__3)) == 13 || ee_1.lb[*i2 - 1] == 28 && (i__4 = ee_1.lb[*i1 - 1], abs(i__4)) == 13)
		{
			if ((i__1 = ee_1.lb[*i1 - 1], abs(i__1)) == 11 || (i__2 = ee_1.lb[*i1 - 1], abs(i__2)) == 13)
			{
				ii = *i1;
	...
	if (*icase == 3)
	{
		...
		else
		{
			*iblock = 100;
			if (rrr < *brel + *brsgm)
			{
				ee_1.lb[*i1 - 1] = -15 - (int)(ranart_(&rndf77_1.nseed) *3);
				cc_1.e[*i1 - 1] = 1.1974f;
			}
			else
			{
...
int crkkpi_(int *i1, int *i2, float *xsk1, float *xsk2,float *xsk3, float *xsk4, float *xsk5, float *xsk6, float *xsk7, float *xsk8, float *xsk9, float *xsk10, float *xsk11, float *sigk, int *iblock, int *lbp1, int *lbp2, float *emm1, float *emm2)
{
	static float x1;
	extern double ranart_(int *);
...
int crkhyp_(float *px, float *py, float *pz, float *srt, int *i1, int *i2, float *xky1, float *xky2, float *xky3, float *xky4,float *xky5, float *xky6, float *xky7, float *xky8, float *xky9, float *xky10, float *xky11, float *xky12, float *xky13, float *xky14, float *xky15, float *xky16, float *xky17, float *sigk, int *ikmp, int *iblock)
{
	float r__1, r__2, r__3, r__4, r__5;
...
int crkpla_(float *px, float *py, float *pz, float *ec, float *srt, float *spika, float *emm1, float *emm2, int *lbp1, int *lbp2, int *i1, int *i2, int *icase, float *srhoks)
{
	...
	static int ic;
	static float pr, ct1, pr2, px0, py0, pz0, st1, pdd, pff, sig1, sig2, xkp0,xkp1, xkp2, xkp3, xkp4, xkp5, xkp6, xkp7, xkp8, xkp9, sigm, dskn,xkp10, randu, sigkp, dsknr;
	...
	*lbp2 = 0;
	...
	r__1 = *srt;
	r__2 = *srt;
	pdd = (r__1 * r__1 - .40063836159999994f) * (r__2 * r__2 -.13179804160000003f);
...
L70:
	...
	if (*srt > 1.518f)
	{
		r__1 = *srt;
		r__2 = *srt;
		pff = sqrt((r__1 * r__1 - 2.3043240000000003f) * (r__2 * r__2 -.272484f));
		r__1 = *srt;
		...
		if (*srt > 1.915f)
		{
			r__1 = *srt;
			r__2 = *srt;
			pff = sqrt((r__1 * r__1 - 3.6672250000000002f) * (r__2 * r__2 -.015625f));
			r__1 = *srt;
...
int crkphi_(float *px, float *py, float *pz, float *ec, float *srt, int *iblock, float *emm1, float *emm2, int *lbp1, int *lbp2, int *i1, int *i2, int *ikk, int *icase, float *rrkk, float *prkk)
{
	...
	static float pr;
	static int lb1, lb2;
	static float ct1, pr2, px0, py0, pz0, st1, pii, sig, dnr, sig1, sig2, sig3,xsk1, srr1, srr2, srr3, xsk2, xsk3, xsk4, xsk5, xsk6, xsk7, xsk8,xsk9, sigm, dskn, xsk10, xsk11, ranx, srri, srrt, sigm0, prkk0,rrkk0, sigks, dsknr, sigks1, sigks2, sigks3, sigks4;
	extern int distce_(int *, int *, float *, float *,float *, float *, float *, int *, float *, float *, float *),crkkpi_(int *, int *, float *, float *, float *, float *,float *, float *, float *, float *, float *, float *, float *, float *,int *, int *, int *, float *, float *);
	extern double ranart_(int *);
	extern int xkkann_(float *, float *, float *, float *, float *, float *, float *, float *, float *, float *, float *, float *, float *, float *),crkspi_(int *, int *, float *, float *, float *,float *, float *, int *, int *, int *, float *, float *),xkksan_(int *, int *, float *, float *, float *, float *,float *, float *, float *);
	...
	*emm1 = 1.02f;
	...
	else
	{
		if (lb1 == 23 && lb2 == 21 || lb2 == 23 && lb1 == 21)
		{
			crkkpi_(i1, i2, &xsk1, &xsk2, &xsk3, &xsk4, &xsk5, &xsk6, &xsk7, &xsk8, &xsk9, &xsk10, &xsk11, &sigm0, iblock, lbp1, lbp2,emm1, emm2);
		}
		else if (lb1 == 21 && lb2 == 30 || lb2 == 21 && lb1 == 30 || lb1 == 23 && lb2 == -30 || lb2 == 23 && lb1 == -30)
		{
			crkspi_(i1, i2, &sigks1, &sigks2, &sigks3, &sigks4, &sigm0,iblock, lbp1, lbp2, emm1, emm2);
		}
	}
...
int crksph_(float *px, float *py, float *pz, float *ec, float *srt, float *emm1, float *emm2, int *lbp1, int *lbp2, int *i1, int *i2, int *ikkg, int *ikkl, int *iblock,int *icase, float *srhoks)
{
	float r__1, r__2, r__3, r__4, r__5;
	...
	static float pr;
	static int lb1, lb2;
	static float ct1, pr2, px0, py0, pz0, st1, pff, pii, dnr, sig1, sig2,sig11, sig22, dskn, ranx, sigkm, sigks, dsknr, sigela;
	extern int distce_(int *, int *, float *, float *,float *, float *, float *, int *, float *, float *, float *);
	extern double ranart_(int *);
	...
	*icase = 0;
	...
	else
	{
		...
		else if (abs(lb1) == 30 && (lb2 >= 25 && lb2 <= 27) || abs(lb2) ==30 &&(lb1 >= 25 && lb1 <= 27))
		{
			dnr = 54.f;
			*ikkl = 0;
			*iblock = 225;
...
int bbkaon_(int *ic, float *srt, float *px, float *py, float *pz, float *ana, float *plx, float *ply, float *plz, float *ala, float *pkx,float *pky, float *pkz, int *icou1)
{
	float r__1, r__2, r__3, r__4, r__5;
	double sqrt(double), cos(double), sin(double);
	static float t1, t2, ga, ek, el, en, cs, pi, bx, pk, by, bz, pn, ss, dm1,pn2, aka, fai, eln, csn, ssn, fain, elnc, dmax__, prob, pmax;
	static int ntry;
	static float pbeta;
...
{
	static float xarray[19] = {3e-6f, 1.87f, 11.f, 14.9f, 9.35f, 7.65f, 4.62f, 3.45f,2.41f, 1.85f, 1.65f, 1.5f, 1.32f, 1.17f, 1.16f, 1.f, .856f, .745f, 3e-6f};
	static float earray[19] = {1.22f, 1.47f, 1.72f, 1.97f, 2.22f, 2.47f, 2.72f,2.97f, 3.22f, 3.47f, 3.72f, 3.97f, 4.22f, 4.47f, 4.72f, 4.97f, 5.22f, 5.47f,5.72f};
	float ret_val;
	double log(double), exp(double);
	static int ie;
...
{
	static float xarray[15] = {8e-6f, 6.1999999e-5f, 1.88194f, 5.02569f,11.80154f, 13.92114f, 15.07308f, 11.79571f, 11.53772f, 10.01197f,9.792673f, 9.465264f, 8.97049f, 7.944254f, 6.88632f};
	static float earray[15] = {1.22f, 1.47f, 1.72f, 1.97f, 2.22f, 2.47f, 2.72f,2.97f, 3.22f, 3.47f, 3.72f, 3.97f, 4.22f, 4.47f, 4.72f};
	float ret_val;
	double log(double), exp(double);
	static int ie;
	static float plab, xmin, ymin, xmax, ymax, pmass, pmass1;
...
{
	static float xarray[10] = {1e-4f, 1.986597f, 6.411932f, 7.636956f, 9.598362f,9.88974f, 10.24317f, 10.80138f, 11.86988f, 12.83925f};
	static float earray[10] = {2.468f, 2.718f, 2.968f, 3.22f, 3.47f, 3.72f, 3.97f,4.22f, 4.47f, 4.72f};
	float ret_val;
	double log(double), exp(double);
	static int ie;
	static float plab, xmin, ymin, xmax, ymax, pmass, pmass1;
...
double reab_(int *i1, int *i2, float *srt, int *ictrl)
{
	...
	if (*ictrl == 1)
	{
		...
		r__2 = *srt;
		r__3 = ed;
		r__1 = (r__2 * r__2 + .019600000000000003f - r__3 * r__3) / (*srt *2.f);
		...
		if (abs(lb1) >= 10 && abs(lb1) <= 13 || abs(lb2) >= 10 && abs(lb2) <=13)
		{
			factor = 1.f;
		}
	...
	if (*ictrl == 3)
	{
		...
		r__2 = *srt;
		r__3 = ed;
		r__1 = (r__2 * r__2 + .61152400000000007f - r__3 * r__3) / (*srt *2.f);
...
{
	static float earray[14] = {20.f, 30.f, 40.f, 60.f, 80.f, 100.f, 170.f, 250.f,310.f, 350.f, 460.f, 560.f, 660.f, 800.f};
	static float xarray[14] = {150.f, 90.f, 80.6f, 48.f, 36.6f, 31.6f, 25.9f, 24.f,23.1f, 24.f, 28.3f, 33.6f, 41.5f, 47.f};
	float ret_val, r__1;
	double log(double), exp(double);
	static int ie;
...
{
	static float earray[11] = {20.f, 30.f, 40.f, 60.f, 90.f, 135.f, 200.f, 300.f,400.f, 600.f, 800.f};
	static float xarray[11] = {410.f, 270.f, 214.5f, 130.f, 78.f, 53.5f, 41.6f,35.9f, 34.2f, 34.3f, 34.9f};
	float ret_val, r__1;
	double log(double), exp(double);
	static int ie;
	static float ekin, xmin, ymin, xmax, ymax, pmass;
...
int xnd_(float *px, float *py, float *pz, float *srt, int *i1, int *i2, float *xinel, float *sigk, float *xsk1, float *xsk2,float *xsk3, float *xsk4, float *xsk5)
{
	int i__1, i__2, i__3, i__4, i__5, i__6, i__7, i__8;
	float r__1, r__2, r__3, r__4, r__5;
...
int xddin_(float *px, float *py, float *pz, float *srt, int *i1, int *i2, float *xinel, float *sigk, float *xsk1, float *xsk2,float *xsk3, float *xsk4, float *xsk5)
{
	int i__1, i__2, i__3, i__4, i__5, i__6;
	float r__1, r__2, r__3, r__4, r__5;
	double sqrt(double);
...
{
	static float arrayj[19] = {.5f, 1.5f, .5f, .5f, 2.5f, 2.5f, 1.5f, .5f, 1.5f, 3.5f,1.5f, .5f, 1.5f, .5f, 2.5f, .5f, 1.5f, 2.5f, 3.5f};
	static float arrayl[19] = {1.f, 2.f, 0.f, 0.f, 2.f, 3.f, 2.f, 1.f, 1.f, 3.f, 1.f, 0.f, 2.f, 0.f, 3.f, 1.f, 1.f, 2.f, 3.f};
	static float arraym[19] = {1.44f, 1.52f, 1.535f, 1.65f, 1.675f, 1.68f, 1.7f,1.71f, 1.72f, 1.99f, 1.6f, 1.62f, 1.7f, 1.9f, 1.905f, 1.91f, 1.86f, 1.93f,1.95f};
	static float arrayw[19] = {.2f, .125f, .15f, .15f, .155f, .125f, .1f, .11f, .2f,.29f, .25f, .16f, .28f, .15f, .3f, .22f, .25f, .25f, .24f};
	static float arrayb[19] = {.15f, .2f, .05f, .175f, .025f, .125f, .1f, .2f, .53f,.34f, .05f, .07f, .15f, .45f, .45f, .058f, .08f, .12f, .08f};
	int i__1, i__2;
	float ret_val;
	static float pi;
	static int ir;
	static float xs, xs0;
	extern double fdr_(float *, float *, float *, float *, float *, float *,float *, float *);
	static float branch;
	...
	for (ir = 1; ir <= 19; ++ir)
	{
		if (ir <= 8)
		{
			...
			if ((i__1 = *lb1 * *lb2, abs(i__1)) == 26 && (abs(*lb1) == 1 ||abs(*lb2) == 1) ||(i__2 = *lb1 * *lb2, abs(i__2)) == 52 && (abs(*lb1) == 2 || abs(*lb2) == 2))
			{
...
double fdr_(float *dmass, float *aj, float *al, float *width, float *widb0,float *srt, float *em1, float *em2)
{
	float ret_val, r__1, r__2, r__3, r__4, r__5;
...
{
	static float arrayj[17] = {1.5f, .5f, 2.5f, 2.5f, 1.5f, .5f, 1.5f, 3.5f, 1.5f, .5f,1.5f, .5f, 2.5f, .5f, 1.5f, 2.5f, 3.5f};
	static float arrayl[17] = {2.f, 0.f, 2.f, 3.f, 2.f, 1.f, 1.f, 3.f, 1.f, 0.f, 2.f,0.f, 3.f, 1.f, 1.f, 2.f, 3.f};
	static float arraym[17] = {1.52f, 1.65f, 1.675f, 1.68f, 1.7f, 1.71f, 1.72f,1.99f, 1.6f, 1.62f, 1.7f, 1.9f, 1.905f, 1.91f, 1.86f, 1.93f, 1.95f};
	static float arrayw[17] = {.125f, .15f, .155f, .125f, .1f, .11f, .2f, .29f, .25f,.16f, .28f, .15f, .3f, .22f, .25f, .25f, .24f};
	static float arrayb[17] = {.55f, .6f, .375f, .6f, .1f, .15f, .15f, .05f, .35f, .3f,.15f, .1f, .1f, .22f, .2f, .09f, .4f};
	float ret_val;
	static float pi;
	static int ir;
	static float xs;
...
double fd1_(float *dmass, float *aj, float *al, float *width, float *widb0,float *srt)
{
	float ret_val, r__1, r__2, r__3, r__4, r__5;
	double d__1, d__2, d__3, d__4;
...
double dpion_(float *em1, float *em2, int *lb1, int *lb2, float *srt)
{
	...
	static float arraym[19] = {1.44f, 1.52f, 1.535f, 1.65f, 1.675f, 1.68f, 1.7f,1.71f, 1.72f, 1.99f, 1.6f, 1.62f, 1.7f, 1.9f, 1.905f, 1.91f, 1.86f, 1.93f,1.95f};
	static float arrayw[19] = {.2f, .125f, .15f, .15f, .155f, .125f, .1f, .11f, .2f,.29f, .25f, .16f, .28f, .15f, .3f, .22f, .25f, .25f, .24f};
	static float arrayb[19] = {.15f, .25f, 0.f, .05f, .575f, .125f, .379f, .1f, .1f,.062f, .45f, .6f, .6984f, .05f, .25f, .089f, .19f, .2f, .13f};
	int i__1, i__2;
	float ret_val;
	static float pi;
	static int ir;
	static float xs;
	extern double fd2_(float *, float *, float *, float *, float *, float *,float *, float *);
	static float xs0, amn, amp, branch;
	...
	for (ir = 1; ir <= 19; ++ir)
	{
		...
		if (ir <= 8)
		{
			...
			if ((i__1 = *lb1 * *lb2, abs(i__1)) == 28 && (*lb1 == 4 || *lb2 ==4) ||(i__2 = *lb1 * *lb2, abs(i__2)) == 32 && (*lb1 == 4 ||*lb2 == 4))
			{
				branch = .33333333333333331f;
			}
		...
		else
		{
			...
			if ((i__1 = *lb1 * *lb2, abs(i__1)) == 36 && (*lb1 == 4 || *lb2 ==4) ||(i__2 = *lb1 * *lb2, abs(i__2)) == 24 && (*lb1 ==4 ||*lb2 == 4))
			{
...
double fd2_(float *dmass, float *aj, float *al, float *width, float *widb0,float *em1, float *em2, float *srt)
{
	float ret_val, r__1, r__2, r__3, r__4, r__5;
	double d__1, d__2, d__3, d__4;
...
int rmasdd_(float *srt, float *am10, float *am20, float *dmin1,float *dmin2, int *iseed, int *ic, float *dm1, float *dm2)
{
	float r__1, r__2, r__3, r__4, r__5, r__6;
	...
	extern double fmassd_(float *), ranart_(int *), fmassn_(float *),fmassr_(float *);
	amn = .94f;
	amp = .14f;
	dmax1 = *srt - *dmin2;
L20:
...
int pertur_(float *px, float *py, float *pz, float *srt, int *irun, int *i1, int *i2, int *nt, int *kp, int *icont)
{
	...
	*icont = 1;
	icsbel = -1;
	if ((lb1 == 21 || lb1 == 23 || abs(lb1) == 30) && (abs(lb2) >= 14 && abs(lb2) <= 17))
	{
		goto L60;
	}
	if ((lb2 == 21 || lb2 == 23 || abs(lb2) == 30) && (abs(lb1) >= 14 && abs(lb1) <= 17))
	{
		goto L60;
	}
	if ((lb1 == 21 || lb1 == 23 || abs(lb1) == 30) && (abs(lb2) == 40 || abs(lb2) == 41))
	{
		goto L70;
	}
	if ((lb2 == 21 || lb2 == 23 || abs(lb2) == 30) && (abs(lb1) == 40 || abs(lb1) == 41))
	{
		goto L70;
	}

	if ((lb1 >= 3 && lb1 <= 5 || lb1 == 0) && (abs(lb2) == 40 || abs(lb2) ==41) ||(lb2 >= 3 && lb2 <= 5 || lb2 == 0) && (abs(lb1) == 40 ||abs(lb1) == 41))
	{
		goto L90;
	}
